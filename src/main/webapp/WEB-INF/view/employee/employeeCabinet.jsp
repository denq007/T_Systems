                ...
                <form class="needs-validation" novalidate>
                    <div class="row g-3">
                        ...
                        <form:hidden path="id" value="${customer.id}"/>
                            &lt;%&ndash;  <form:hidden path="userDTO" value="${customer.userDTO.userId}"/>&ndash;%&gt;
                        ...
                        <button class="w-100 btn btn-primary btn-lg" type="submit"> Create user and customer</button>
                          ...
                          <form action="/customer/showcustomer" method="get" >
                            ...
                            <button class="w-100 btn btn-primary btn-lg" type="submit" >Show customer</button>
                          </form>
                        <button class="w-100 btn btn-primary btn-lg" type="submit" href="/customer/editcustomer">Edit customer information</button>

                        <button class="w-100 btn btn-primary btn-lg" type="submit" href="/customer/showallcustomer">Show all customers</button>
                        <button class="w-100 btn btn-primary btn-lg" type="submit" href="/editcontract">Show all contracts</button>
